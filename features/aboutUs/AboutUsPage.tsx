...
const AboutUsPage = () => {
  return (
    <div className="mx-4 flex h-[calc(100dvh-155px)] flex-wrap items-center justify-center gap-6 md:mx-10 md:gap-10 lg:max-h-[calc(100dvh-185px)]">
      {/* body */}
            ...
            <div className="flex flex-col gap-4 md:gap-10">
              ...
              <div className="flex flex-col gap-7 md:gap-15">
                <div className="text-sm md:text-lg">
                  ...
                  that the right gear shouldn&apos;t just fit you it should
                  inspire you.
                </div>
